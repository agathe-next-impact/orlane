                    ...
                    'layout_fb_features' => [
                        ...
                        'sub_fields' => [
                            ...
                            [
                                ...
                                'type'              => 'select',
                                'choices'           => [
                                    'default'            => '1. Grille de cartes',
                                    'with_ctas'          => '2. Cartes avec liens (3 col.)',
                                    'icons_cta'          => '3. Cartes avec bouton (2 col.)',
                                    'rounded_icons'      => '4. Cartes avec icônes rondes',
                                    'numbered'           => '5. Étapes numérotées',
                                    'dark'               => '6. Sans boîte',
                                    'horizontal'         => '7. Liste horizontale',
                                    'image_right'        => '8. Cartes + image de section',
                                    'split_description'  => '9. Texte à gauche + liste',
                                    'alternating'        => '10. Image et liste en alternance',
                                ],
                            ...
                            [
                                'key' => 'field_fb_features_header_image',
                                'label' => 'Image d\'en-tête',
                                'name' => 'header_image',
                                'type' => 'image',
                                'return_format' => 'id',
                                'preview_size' => 'medium',
                                'instructions' => 'Image décorative affichée à côté du titre et de la description.',
                            ],
                            [
                            ...
                            [
                                ...
                                'sub_fields' => [
                                    [
                                        ...
                                        'instructions' => 'Image pour cette fonctionnalité (prioritaire sur l\'icône).',
                                    ],
                                    [
                                        'key' => 'field_fb_feature_icon_name',
                                        'label' => 'Icône (alternative)',
                                        'name' => 'icon',
                                        'type' => 'select',
                                        'instructions' => 'Icône affichée si aucune image n\'est définie. Bibliothèque Lucide.',
                                        'choices' => [
                                            ''              => '— Aucune —',
                                            'heart'         => '❤ Cœur',
                                            'star'          => '⭐ Étoile',
                                            'check'         => '✓ Check',
                                            'check-circle'  => '✓○ Check cercle',
                                            'award'         => '🏆 Récompense',
                                            'trophy'        => '🏆 Trophée',
                                            'gift'          => '🎁 Cadeau',
                                            'sparkles'      => '✨ Étincelles',
                                            ...
                                            'headphones'    => '🎧 Casque',
                                            'mic'           => '🎤 Micro',
                                            'trending-up'   => '📈 Tendance hausse',
                                            'bar-chart-3'   => '📊 Graphique',
                                            'pie-chart'     => '🥧 Camembert',
                                            'layers'        => '📚 Couches',
                                            'grid-3x3'      => '▦ Grille',
                                            'layout'        => '📐 Mise en page',
    ...
    acf_add_local_field_group([
        ...
        'fields'                => [
            ...
            [
                ...
                'label'             => 'Surface (fonds subtils, bordures)',
                'name'              => 'color_surface',
                'type'              => 'color_picker',
            ...
            [
                ...
                'label'             => 'Ink (texte principal, titres)',
                'name'              => 'color_ink',
                'type'              => 'color_picker',
            ...
            [
                ...
                'label'             => 'Primary (accent primaire, boutons)',
                'name'              => 'color_primary',
                'type'              => 'color_picker',
            ...
            [
                ...
                'label'             => 'Secondary (accent secondaire)',
            ...
            [
                ...
                'label'             => 'Variation 1',
                'type'              => 'message',
                'message'           => '<strong>Combinaison de couleurs n°1</strong> — Sélectionnez parmi les couleurs de la palette ci-dessus.',
            ],
            [
                ...
                'type'              => 'select',
                'choices'           => [
                    'canvas'    => 'Canvas (fond principal)',
                    'surface'   => 'Surface (fond subtil)',
                    'ink'       => 'Ink (sombre)',
                    'primary'   => 'Primary (accent)',
                    'secondary' => 'Secondary (accent foncé)',
                ],
            ...
            [
                'key'               => 'field_ts_variation_1_accent',
                'label'             => 'Variation 1 — Accent',
                'name'              => 'variation_1_accent',
                'type'              => 'select',
                'choices'           => [
                    'primary'   => 'Primary (accent)',
                    'secondary' => 'Secondary (accent foncé)',
                ...
                'return_format'     => 'value',
                'instructions'      => 'Couleur d\'accent (bordures, icônes, boutons).',
            ],
            ...
            [
                'key'               => 'field_ts_variation_2_accent',
                'label'             => 'Variation 2 — Accent',
                'name'              => 'variation_2_accent',
                'type'              => 'select',
                'choices'           => [
                    'primary'   => 'Primary (accent)',
                    'secondary' => 'Secondary (accent foncé)',
            ...
            [
                'key'               => 'field_ts_variation_3_accent',
                'label'             => 'Variation 3 — Accent',
                'name'              => 'variation_3_accent',
                'type'              => 'select',
                'choices'           => [
                    'primary'   => 'Primary (accent)',
                    'secondary' => 'Secondary (accent foncé)',
            ...
            // ── Apparence (CTA, inputs) ──────────────────────────
            [
                'key'               => 'field_ts_tab_appearance',
                'label'             => 'Apparence',
                'type'              => 'tab',
            ],
            ...
            // Bouton primaire
            [
                'key'               => 'field_ts_appearance_btn_msg',
                'label'             => '',
                'type'              => 'message',
                'message'           => '<strong>Bouton primaire (CTA)</strong> — Style par défaut des boutons d\'appel à l\'action.',
            ],
            [
                'key'               => 'field_ts_btn_radius',
                'label'             => 'Arrondi des boutons',
                'name'              => 'btn_radius',
                'type'              => 'select',
                'choices'           => [
                    'none'  => 'Aucun (angles droits)',
                    'sm'    => 'Petit (4px)',
                    'md'    => 'Moyen (8px)',
                    'lg'    => 'Grand (12px)',
                    'xl'    => 'Très grand (16px)',
                    'full'  => 'Pilule (arrondi complet)',
                ],
                'default_value'     => 'lg',
                'return_format'     => 'value',
                'instructions'      => 'Border-radius appliqué aux boutons CTA.',
            ],
            [
                'key'               => 'field_ts_btn_size',
                ...
                'choices'           => [
                    ...
                    'lg'    => 'Grand (px-5 py-3)',
                    'xl'    => 'Très grand (px-6 py-3.5)',
                ],
                'default_value'     => 'lg',
                'return_format'     => 'value',
                'instructions'      => 'Taille (padding) des boutons.',
            ],
            [
                'key'               => 'field_ts_btn_font_weight',
                ...
                'return_format'     => 'value',
                'instructions'      => 'Poids de la police des boutons.',
            ],
            [
                'key'               => 'field_ts_btn_uppercase',
                'label'             => 'Texte en majuscules',
                'name'              => 'btn_uppercase',
                'type'              => 'true_false',
                'default_value'     => 0,
                'ui'                => 1,
                'instructions'      => 'Afficher le texte des boutons en lettres capitales.',
            ],
            [
                'key'               => 'field_ts_btn_shadow',
                'label'             => 'Ombre portée',
                'name'              => 'btn_shadow',
                'type'              => 'select',
                'choices'           => [
                ...
                'default_value'     => 'none',
                'return_format'     => 'value',
                'instructions'      => 'Ombre portée sur les boutons.',
            ],

            // Bouton secondaire
            [
                'key'               => 'field_ts_appearance_btn2_msg',
                'label'             => '',
                'type'              => 'message',
                'message'           => '<strong>Bouton secondaire</strong> — Style du second bouton lorsqu\'il y en a deux.',
            ],
            [
                'key'               => 'field_ts_btn2_style',
                'label'             => 'Style du bouton secondaire',
                'name'              => 'btn2_style',
                'type'              => 'select',
                'choices'           => [
                    'outlined'  => 'Contour (outlined)',
                    'ghost'     => 'Transparent (ghost)',
                    'filled'    => 'Rempli (couleur atténuée)',
                    'link'      => 'Lien texte simple',
                ],
                'default_value'     => 'outlined',
                'return_format'     => 'value',
                'instructions'      => 'Apparence du bouton secondaire.',
            ],

            // Champs de formulaire
            [
                'key'               => 'field_ts_appearance_input_msg',
                'label'             => '',
                'type'              => 'message',
                'message'           => '<strong>Champs de formulaire</strong> — Style des inputs, textarea, select.',
            ],
            [
                'key'               => 'field_ts_input_radius',
                ...
                'default_value'     => 'lg',
                'return_format'     => 'value',
                'instructions'      => 'Border-radius appliqué aux champs de saisie.',
            ],
            [
                'key'               => 'field_ts_input_style',
                'label'             => 'Style des champs',
                'name'              => 'input_style',
                'type'              => 'select',
                'choices'           => [
                    'default'   => 'Par défaut (bordure complète)',
                    'underline' => 'Soulignement (bordure basse)',
                    'filled'    => 'Rempli (fond coloré, sans bordure)',
                ],
                'default_value'     => 'default',
                'return_format'     => 'value',
                'instructions'      => 'Style visuel des champs de saisie.',
            ],
            ...
            [
                ...
                'return_format'     => 'value',
                'instructions'      => 'Utilise les combinaisons de couleurs définies dans l\'onglet Variations.',
            ],
            [
